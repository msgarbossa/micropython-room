...
from machine import Pin, ADC, Timer, RTC, TouchPad, deepsleep, I2C, SoftI2C
import esp32
...
# Crate AnyTemp object (abstraction for different temp sensors)
...
# Give extra time on first boot in case webrepl is needed
if doPowerOn:
  wait_for_sensor(25)
